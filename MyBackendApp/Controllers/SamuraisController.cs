...
namespace MyBackendApp.Controllers
{
    ...
    public class SamuraisController : ControllerBase
    {
        ...
        public IActionResult DeleteSamurai(DeleteSamuraiDTO deleteSamuraiDTO)
        {
            try
            {
                _samurai.DeleteSamuraiBattle(deleteSamuraiDTO.SamuraiId, deleteSamuraiDTO.BattleId);
                return Ok($"Samurai id {deleteSamuraiDTO.SamuraiId} berhasil dihapus dari battle {deleteSamuraiDTO.BattleId}");
            }
            catch (Exception ex)
            {
                return BadRequest(ex.Message);
        ...
        [HttpGet("SaidWord")]
        public IEnumerable<SamuraiGetDTO> GetSamuraiWithSaidWord(string text)
        {
            var samurai = _samurai.GetSamuraiWithSaidWord(text);
            var samuraiGetDTO = _mapper.Map<IEnumerable<SamuraiGetDTO>>(samurai);
            return samuraiGetDTO;
